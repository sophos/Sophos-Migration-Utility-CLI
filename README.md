...
17. When using the -A option to include interfaces and VLANs, it is necessary to modify and verify the name, zone, and other details of the objects before importing into SFOS. Processing via Sophos Firewall Config Studio is recommended when using this option.
